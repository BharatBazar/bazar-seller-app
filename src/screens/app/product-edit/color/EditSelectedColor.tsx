import { FontFamily, fs12, fs14, fs15 } from '@app/common';
import { mainColor } from '@app/common/color';
import { getWP } from '@app/common/dimension';
import { AIC, BGCOLOR, BR, DSP, FDR, FLEX, JCC, MA, ML, MR, provideShadow } from '@app/common/styles';
import { BRA, MTA, MVA } from '@app/common/stylesheet';
