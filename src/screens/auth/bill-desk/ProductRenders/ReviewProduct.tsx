        ...
        <View style={[styles.card]}>
            <View style={[FDR(), JCC('space-between')]}>
                ...
                <View style={[AS('center')]}>
                    <GeneralText
                        text={`${item.quantity} × ${item.productId.parentId.name}`}
                ...
                <View style={[AS('center')]}>
                    <GeneralText
                        ...
                        textStyle={[FC('#252525'), { fontFamily: FontFamily.Bold }]}
                    />
                </View>
                <TouchableOpacity onPress={() => removeItem(item._id)} style={[AS(), PR(0.2)]}>
